        ...
        (<div className=" d-flex pt-5 pb-5 row">
          <Zoom>
            <div className="col-lg-6 col-12 d-flex justify-content-lg-end justify-content-center video-wrapper">
              <iframe title="Counsel" className="shadow position-relative info-img" width="500" height="325" src="https://www.youtube.com/embed/c2EW1xj_JBU" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            </div>
          </Zoom>
          <Bounce right>
